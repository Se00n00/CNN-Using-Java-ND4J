...
public class DataSetPrepration {
    ...
    DataSetPrepration(int IMG_HEIGHTS,int IMG_WIDTHS){
    ...
    public void CreateDataset(String SourcePath,String OutputPath) throws IOException {
        ...
        File trainFolder = new File(Destination, "train");
        File testFolder = new File(Destination, "test");
        double trainTestSplitRatio = 0.8;

        try {
            splitAndResizeDataset(Source, trainFolder, testFolder, trainTestSplitRatio, this.IMG_WIDTHS, this.IMG_HEIGHTS);
